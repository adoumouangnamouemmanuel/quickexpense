...
const dictionaries = {
  en: {
    ...
    installHint: 'Add QuickExpense to your home screen for the best experience.',
    ...
    familyDescription: 'Share your data with family or friends without creating an account.',
  ...
  fr: {
    ...
    installHint: "Ajoutez QuickExpense à votre écran d'accueil pour la meilleure expérience.",
    ...
    familyDescription: 'Partagez vos données avec votre famille sans créer un compte.',
...
export function LanguageProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <LanguageContext.Provider value={{ language, setLanguage, t: dictionaries[language] as typeof dictionaries.en }}>
      {children}
